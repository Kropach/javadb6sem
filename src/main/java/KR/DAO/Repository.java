...
public interface Repository<P, S> {
    ...
    void addStation(int pathNumber, Station station) throws SQLException;
    void changePath(int pathNumber, int trainNumber, String pathName) throws SQLException;
    void changeStation(int pathNumber, int stationNumber,  String name, String timeA, String timeD) throws SQLException;
