...
//                    }
                ...
                case 4:
                    ...
                    Station station = new Station(scanner.next(), scanner.next(), scanner.next());
...
//                    }
                    break;
                case 5:
                    System.out.println("Input path and station number and new station(name, arr and dep time)");
                    service.changeStation(scanner.nextInt(), scanner.nextInt(), scanner.next(), scanner.next(), scanner.next());
//                    try {
//
//                    } catch (Exception e) {
...
//                    }
                    break;
                case 6:
                    System.out.println("Input path index, new path number and name");
                    try {
